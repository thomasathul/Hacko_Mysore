function GUI2()
    ...
    mainFig = figure('Name', 'CryptoGraphy & StegnoGraphy on Image', 'Position', [200, 200, 400, 300], 'Color', [0.9 0.9 0.9],'Toolbar','none','Menubar','none');
    set(mainFig,'NumberTitle','off');
    % Create the encrypt button
    encryptBtn = uicontrol('Parent', mainFig, 'Style', 'pushbutton', 'String', 'ENCRYPT', 'Position', [150, 20, 100, 30], 'BackgroundColor', 'cyan', 'Callback', @showEncryptPanel);

    % Create the decrypt button
    decryptBtn = uicontrol('Parent', mainFig, 'Style', 'pushbutton', 'String', 'DECRYPT', 'Position', [260, 20, 100, 30], 'BackgroundColor', 'cyan', 'Callback', @showDecryptPanel);
    ...
    encryptSendBtn = uicontrol('Parent', encryptPanel, 'Style', 'pushbutton', 'String', 'ENCODE', 'Position', [140, 30, 100, 30], 'BackgroundColor', 'white', 'Callback', @encryptSendCallback);
    ...
    decryptSendBtn = uicontrol('Parent', decryptPanel, 'Style', 'pushbutton', 'String', 'DECODE', 'Position', [140, 30, 100, 30], 'BackgroundColor', 'white', 'Callback', @decryptSendCallback);
    % Callback functions
    ...
    function encryptSendCallback(~, ~)
        ...
        s2=~s1;
        figure('Name', 'SecretImage','NumberTitle','off','Toolbar','none','Menubar','none');
        imshow(y)
        figure('Name', 'Negate_SecreteImage','NumberTitle','off','Toolbar','none','Menubar','none');
        imshow(s1)
        figure('Name', 'Negate_SecreteImage','NumberTitle','off','Toolbar','none','Menubar','none');
        imshow(s2)
        ...
        figure('Name', 'Encoded_Image_1','NumberTitle','off','Toolbar','none','Menubar','none');
        imshow(idct_val_1);
        imwrite(idct_val_1,"D:\Hackathon\Hacko_Mysore-main\V2\gen\Encodedimage1.jpg",Quality = 100);
        cnt = 0;
        s2_array = s2(:);
        idct_val_2 = c12;
        ...
        figure('Name', 'Encoded_Image_2','NumberTitle','off','Toolbar','none','Menubar','none');
        imshow(idct_val_2);
        imwrite(idct_val_2,"D:\Hackathon\Hacko_Mysore-main\V2\gen\Encodedimage2.jpg",Quality = 100);
    end
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    function decryptSendCallback(~, ~)
        ...
        figure('Name', 'Decoded_Image_1','NumberTitle','off','Toolbar','none','Menubar','none');
        imshow(s1_out);
        idct_val_2=imread(fullPath5);
        cnt = 0;
        for m1=8:8:768
            for n1=8:8:1024
        ...
        figure('Name', 'Decoded_Image_2','NumberTitle','off','Toolbar','none','Menubar','none');
        imshow(s2_out);
        %corr2(s2,s2_out)
        %corr2(s1,s1_out)
        z1=~s2_out;
        ...
        figure('Name', 'Decoded_Image_2','NumberTitle','off','Toolbar','none','Menubar','none');imshow(sc);
